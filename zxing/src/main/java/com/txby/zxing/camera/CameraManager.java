...
public final class CameraManager {
    ...
    /**
     * Close the camera driver if still in use.
     */
     ...
     * The data will arrive as byte[] in the message.obj field, with width and height
    ...
    public Rect getFramingRect() {
        try {
            ...
            framingRect = new Rect(leftOffset, topOffset,
                    leftOffset + FRAME_WIDTH, topOffset + FRAME_HEIGHT);
            return framingRect;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
