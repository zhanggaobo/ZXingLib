...
import com.txby.zxing.camera.BitmapLuminanceSource;
import com.txby.zxing.camera.CameraManager;
import com.txby.zxing.decoding.DecodeFormatManager;
    ...
    public static void analyzeBitmap(String path, AnalyzeCallback analyzeCallback) {
        ...
        try {
            rawResult = multiFormatReader.decodeWithState(
                    new BinaryBitmap(new HybridBinarizer(new BitmapLuminanceSource(mBitmap))));
        } catch (Exception e) {
            e.printStackTrace();
        }
